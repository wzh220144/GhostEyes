            ...
            <div  class="note-head navbar-wrapper">
                    ...
                    <div class="navbar navbar-default navbar-static-top">
                        <div class="navbar-heade">
                            ...
                            <a class="navbar-brand" href="/index.html"><img src = "<%=path %>/resources/media/img/logo.jpg" /></a>
                        </div>
                ...
                <div class = "fill">
                    ...
                    <div class = "note-aside">
                        ...
                        <div class = "note-aside-body" id = "aside">
                            ...
                            <div id="list1">
                                ...
                                <div class="btn btn-primary title-font hand-cursor" data-toggle="collapse" data-target="#collapse1" data-parent="#aside">
                            ...
                            <div class="list2">
                                ...
                                <div class="btn btn-primary title-font hand-cursor" data-toggle="collapse" data-target="#collapse2" data-parent="#aside">
                                    <span class="glyphicon glyphicon-th-list"></span>
                                    Time&nbsp&nbsp&nbsp
                                </div>
                    ...
                    <div class = "note-content">
                        <div class = "note-content-top">
                            ...
                            <div>
                                <a href = "" id="delete" class = "btn btn-lg btn-primary">
                                    &nbsp;&nbsp;delete&nbsp;&nbsp;
                                </a>
                            </div>
                        </div>
